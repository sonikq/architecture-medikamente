...
Чтобы защитить данные, необходимо использовать механизмы,
инструменты и принципы работы с конфиденциальными данными (подходы Privacy By Design, Data Minimization и Data Lineage).
